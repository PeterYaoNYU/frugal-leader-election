...
# invoke start-clients --serverIp 127.0.0.4 --serverPort 10054 --value 5invoke start-clients --serverIp 127.0.0.4 --serverPort 10054 --value 5
@task
def start_clients(c, serverIp, serverPort, value):
    ...
    client_id_three = 789
    client_id_four = 1011
    bind_ips = ["127.0.0.17", "127.0.0.18", "127.0.0.19", "127.0.0.20"]
