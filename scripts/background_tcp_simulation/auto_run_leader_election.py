...
# def execute_on_node(node, id, build_bazel=True, build_invoke=True, build_fabric=True):
    try:
        ...
        conn.run(f"cd frugal-leader-election && git stash save && git checkout 66be3d79ab1b47ef38cab883bebdeb7d4139488e && bazel-7.5.0 build //:leader_election && bazel-7.5.0 build //:client")
