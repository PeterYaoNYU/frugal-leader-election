...
sudo tc qdisc add dev vlan102 root netem delay 1ms 2ms distribution normal
sudo tc qdisc add dev vlan105 root netem delay 2ms 5ms distribution normal
sudo tc qdisc add dev vlan107 root netem delay 2ms 5ms distribution normal
sudo tc qdisc add dev vlan109 root netem delay 2ms 5ms distribution normal
sudo tc qdisc add dev vlan110 root netem delay 2ms 5ms distribution normal
